...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->string('status')->default('En attente'); // e.g., Pending, Completed, Cancelled
            $table->string('priority')->default('Normale'); // e.g., Low, Medium, High
            $table->string('payment_method')->nullable(); // e.g., Credit Card, PayPal, cash on delivery
            $table->string('payment_status')->default('Non payé'); // e.g., Paid, Unpaid, Refunded
            ...
            $table->string('refund_status')->default('Non remboursé'); // e.g., Not Refunded, Refunded
