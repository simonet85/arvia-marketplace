...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/oh8h8wfzrlw0hk27r2z2lukdxeoqqzrnw6hnwv5crhi5l6e0/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
  ...
  <body class="flex h-screen bg-gray-100">
    ...
    <script>
      tinymce.init({
        ...
        language: 'fr_FR',
        height: 300,
        plugins: 'anchor autolink  emoticons image link lists  searchreplace table  wordcount',
        toolbar: 'blocks fontfamily fontsize | bold italic underline strikethrough | link   table | align lineheight | numlist bullist indent outdent | emoticons ',
        // toolbar2: 'numlist bullist indent outdent | emoticons charmap | removeformat',
        menubar: false,
