...
<html lang="en">
  ...
  <body class="bg-[#f9f8f4] text-gray-800 overflow-x-hidden">
    ...
    <section class="px-4 md:px-12 py-8 max-w-7xl mx-auto">
      <h1 class="text-3xl font-serif text-center mb-6">Soin du Visage</h1>
      ...
      <div class="flex flex-col sm:flex-row gap-4 mb-6 justify-center">
        ...
        >
          ...
          <option value="hyaluronique">Acide Hyaluronique</option>
      ...
      >
        ...
        <div
          data-type="serum"
          data-ingredient="vitc hyaluronique"
          class="product-card border rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition"
        >
          <img
            src="/images/produits/serum-visage.jpg"
            alt="Sérum Éclat"
            class="h-48 w-full object-cover"
          />
          <div class="p-4">
            <h2 class="text-lg font-serif mb-1">Sérum Éclat</h2>
        ...
        >
          <img
            src="/images/produits/creme-nuit.jpg"
            alt="Crème Nuit"
            class="h-48 w-full object-cover"
          />
          <div class="p-4">
            <h2 class="text-lg font-serif mb-1">Crème Nuit</h2>
            <p class="text-sm text-gray-600 mb-2">
              Hydratation intense au beurre de karité
            </p>
            <button
              class="bg-black text-white px-4 py-2 rounded w-full text-sm hover:bg-gray-800 transition"
            >
        ...
        >
          <img
            src="/images/produits/nettoyant-visage.jpg"
            alt="Nettoyant Doux"
            class="h-48 w-full object-cover"
          />
          <div class="p-4">
            <h2 class="text-lg font-serif mb-1">Nettoyant Doux</h2>
            <p class="text-sm text-gray-600 mb-2">À l'aloe vera bio</p>
            <button
              class="bg-black text-white px-4 py-2 rounded w-full text-sm hover:bg-gray-800 transition"
            >
              Voir
        ...
        <div
          data-type="masque"
          data-ingredient="argile"
          class="product-card border rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition"
        >
          <img
            src="/images/produits/masque-argile.jpg"
            alt="Masque Argile"
            class="h-48 w-full object-cover"
          />
          <div class="p-4">
            <h2 class="text-lg font-serif mb-1">Masque Argile</h2>
            <p class="text-sm text-gray-600 mb-2">
